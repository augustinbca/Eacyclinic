...
<title>Exiting User Login</title>
</head>
...
<nav class="navbar navbar-inverse navbar-fixed-top" >
	...
	<div class="jumbotron text-center" style="height:500px; background-image:url('download.jpeg');background-repeat:no-repeat;background-size:1500px 500px;">
	  <h3 style ="margin-top:90px;">Exiting User</h3>
	  <center>
	  <form name="Log" action="otpGen1" method="post" onsubmit="return (Validation());">
	  <h3>If you enter Already exiting Your Email Id</h3>
