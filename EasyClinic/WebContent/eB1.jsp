...
<nav class="navbar navbar-inverse navbar-fixed-top" >
	...
	<div class="jumbotron text-center" >
		...
		<center>
		 ...
		 <tr>
		 <th> Email-Id: </th>
		 <td><input type="text" name="umail" value="<%=a %>" ></td>
		 </tr>
		 <tr>
		 	 </table>
		 </center>
  ...
  try{
	  ...
	  String b=request.getParameter("mail");
       ...
       String sql ="select * from booking where umail='"+b+"'";
        ...
        while(rs.next())
         {
         	...
         	%>
         		...
         		<input type="text" name="dmail" value="<%=rs.getString(2) %>">
         		</div>
         		...
         		<div class="form-group">
         		<label>Time </label>
         		<input type="text" name="time" value="<%=rs.getString(5)%>">
         		</div>
         		<div class="form-group">
         		<label>User Mail id : </label>
         		<input type="text" name="umail" value="<%=rs.getString(6)%>">
         		</div>
         		
         		<div class="form-group">
         		<input type="submit" name="sub" value="Cancel Appointment">
         		</div>
         		</form>
         	           <% 
            }
