...
function bookfun(id){
	...
	var divelement = document.getElementBy(id);
...
<div class="container-fluid">
  ...
  <div class="modal fade" id="myModal" role="dialog">
    ...
    <label class="radio-inline">
      <input type="date" name="optradio" checked>DATE
    </label>
        ...
        <div class="modal-footer">
         ...
         <a href="Book.jsp"> <button type="button" class="btn btn-default"  value="submit">Book</button>
        </a>
        </form>
        </div> 
        </div>
