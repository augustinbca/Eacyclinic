									...
									<tbody>
										<c:forEach items="${Accounts}" var="account">
											<tr>
												...
												<td><c:out value="${account.sex}" /></td>
												<td><c:out value="${account.address}" /></td>
												<td><c:out value="${account.mobileno}" /></td>
												<td><c:out value="${account.dises}" /></td>
												<td><c:out value="${account.previous}" /></td>
												<td><c:out value="${account.drname}" /></td>
