...
<nav class="navbar navbar-inverse navbar-fixed-top" >
     <div class="container">
	  ...
	  <ul class="nav navbar-nav navbar-right"> 
	    <li><a href="Doctorcreate.jsp">Registration</a></li>
		 <li><a href="ShowDoctorDetails.jsp">View Doctor Details</a></li>
		  <li><a href="ShowBookingDetails.jsp">View Bookings</a></li>
