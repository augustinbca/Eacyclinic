...
<nav class="navbar navbar-inverse navbar-fixed-top" >
	...
	<div class="jumbotron text-center" style="height:500px; background-image:url('dhome.jpg');background-repeat:no-repeat;background-size:1500px 500px;">
	  <h3 style ="margin-top:90px;">Find your Doctor!</h3>
	  <form action="MainDoctorSea.jsp" method="#">
	  <div class="search">
	  <input type="text" name="doctor" placeholder="Doctor" >
	  <input type="text" name="location" placeholder="Location" >
	  <input type="text" name="specialist" placeholder="Specialization" >
	  <input type="submit" class="btn-search" value="Search"><br>
