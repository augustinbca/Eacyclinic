...
<form action="BookingDetails.jsp" ><center>
<div class="search">
	  <input type="text" name="name" class="sea1"  placeholder="Doctor">
	  <input type="text" name="location" class="sea2"  placeholder="Location">
	  <input type="text" name="spec" class="sea3"  placeholder="Specialization">
