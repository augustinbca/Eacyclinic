...
<body>
   <nav class="navbar navbar-inverse navbar-fixed-top" >
	  ...
	  <ul class="nav navbar-nav navbar-right"> 
	    <li><a href="Adminlogin.jsp">Admin</a></li>
		 <li><a href="DoctorLogin.jsp">Doctor</a></li>
		  <li><a href="UserLogin.jsp">Exist User</a></li>
	...
	<div class="jumbotron text-center" style="height:500px; background-image:url('download.jpeg');background-repeat:no-repeat;background-size:1500px 500px;">
	  <form name="Doctor Login" action="DoctorLoginServlet" method="POST" style="margin-top:50px;">
        <div class="form-group">
        <h2 style="margin-left:70px;">Doctor  Login</h2>
