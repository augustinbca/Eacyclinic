...
<form action="UpdaPro" method="post">
...
<% 
        ...
        while(rs.next())
         {
         	...
         	%>
         		...
         		<tr><td>mail :</td>
         		<td><input type="text" name="mail" value="<%=rs.getString(2) %>"></td></tr>
         		<tr><td>Age</td>
 ...
 <button type="submit" class="buttonupd">UPDATE</button><br>
         <a href="UserHome.jsp" class="btnback">BACK</a>         
</table> </center></form>
